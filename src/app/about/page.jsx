      ...
      <section className={styles.aboutContainer}>
        <header className={styles.Container}>
          ...
          <motion.p
            ...
            Experienced Front End Developer proficient in HTML, CSS, JavaScript, React Js, Next Js, TypeScript, Framer-motion. Successfully delivered responsive web apps with seamless server-side integration. Excited to contribute expertise for the growth of an innovative organization.
          </motion.p>
        </header>
        <motion.div
          initial={{ opacity: 0, }}
